...
contribution behaves as a smooth external component with negligible
perturbations in our frame. We do not assume a specific global metric
embedding for the overlap region. Instead, we treat the external domain
as an effective contribution to the averaged background curvature within
our observable patch, analogous to the backreaction
approach~\cite{Buchert2000}. The assumption of negligible domain
