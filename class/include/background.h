...
enum equation_of_state {CLP,EDE,CPL_PLUS};

/** list of possible coupling types between dark energy and dark matter */

enum coupling_type {NO_COUPLING,CONSTANT_COUPLING,VARIABLE_COUPLING};

/** list of possible modified gravity parameterizations */

enum mg_parametrization {NO_MG,OMEGA_DE_DEPENDENT,REDSHIFT_DEPENDENT};
...
struct background
{
  ...
  /* Dark energy - dark matter coupling parameters */
  short has_coupling; /**< flag for presence of dark energy - dark matter coupling */
  enum coupling_type coupling_type; /**< type of coupling between dark energy and dark matter */
  double coupling_z_transition; /**< redshift where coupling becomes significant */
  double coupling_strength; /**< coupling strength parameter */
  double coupling_exponent; /**< power-law exponent for coupling evolution */

  /* Modified gravity parameters */
  short use_modified_gravity; /**< flag for presence of modified gravity */
  enum mg_parametrization mg_parametrization; /**< parametrization scheme for modified gravity */
  double mg_z_transition; /**< redshift where modifications become significant */
  double mg_Y_today; /**< present-day modification to growth factor */
  double mg_eta_today; /**< present-day modification to gravitational slip */
